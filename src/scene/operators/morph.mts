...
export class Morph extends BinaryOperator {
    ...
    override compile(indentLevel = 0): CompileResult {
        ...
        return binaryIsoCompileResult(this, varName, lhResult, rhResult, (l, r) => `sdfMorphEx(${l}, ${r}, ${mt})`, "selectSDF")
    }
    override compileFast(indentLevel = 0): CompileResult {
        ...
        const varName = `morph_${lhResult.varName}__${rhResult.varName}`
        const mt = f32Wgsl(this.paramOffset, this.previewF32Slot)
        return binaryIsoCompileResult(this, varName, lhResult, rhResult, (l, r) => `sdfMorphFast(${l}, ${r}, ${mt})`, "selectFast")
    }
    override compileMid(indentLevel = 0): CompileResult {
        ...
        const varName = `morph_${lhResult.varName}__${rhResult.varName}`
        const mt = f32Wgsl(this.paramOffset, this.previewF32Slot)
        return binaryIsoCompileResult(this, varName, lhResult, rhResult, (l, r) => `sdfMorphMid(${l}, ${r}, ${mt})`, "selectMid")
    }
}
