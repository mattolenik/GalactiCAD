...
/**
 * Default palette of 32 pastel colors.
 * These are soft, visually distinct colors good for distinguishing shapes.
 */
export const DEFAULT_PALETTE: Vec3f[] = [
 ...
 */
export function getDefaultColor(shapeId: number): Vec3f {
    return DEFAULT_PALETTE[shapeId % PALETTE_SIZE]
}
