...
export class Engrave extends BinaryOperator {
    ...
    override compile(indentLevel = 0): CompileResult {
        ...
        return binaryIsoCompileResult(this, varName, lhResult, rhResult, (l, r) => `fOpEngraveEx(${l}, ${r}, ${er})`, "selectSDF")
    }
    override compileFast(indentLevel = 0): CompileResult {
        ...
        const varName = `engrave_${lhResult.varName}__${rhResult.varName}`
        const er = f32Wgsl(this.paramOffset, this.previewF32Slot)
        return binaryIsoCompileResult(this, varName, lhResult, rhResult, (l, r) => `fOpEngraveFast(${l}, ${r}, ${er})`, "selectFast")
    }
    override compileMid(indentLevel = 0): CompileResult {
        ...
        const varName = `engrave_${lhResult.varName}__${rhResult.varName}`
        const er = f32Wgsl(this.paramOffset, this.previewF32Slot)
        return binaryIsoCompileResult(this, varName, lhResult, rhResult, (l, r) => `fOpEngraveMid(${l}, ${r}, ${er})`, "selectMid")
    }
}
